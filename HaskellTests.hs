...
import SectionIA.Task27Test (sectionIATask27Tests)
import SectionIB.Task65Test (sectionIBTask65Tests)
import SectionII.Task2Test (sectionIITask2Tests)
import SectionIII.Task11Test (sectionIIITask11Tests)
import SectionIV.Task7Test (sectionIVTask7Tests)
