...
2. Приклад із кількома зростаючими ділянками перевіряє основний сценарій розбиття списку зі збереженням порядку елементів.
3. Повністю зростаючий список перевіряє, що вся послідовність залишається одним підсписком.
4. Список з рівними сусідніми значеннями перевіряє, що рівність не вважається строгим зростанням і починає новий підсписок.

## Екранний знімок з результатами виконання тестів

![Результати тестів задачі 2](../assets/section-ii-task-2.pl.png)
